...
public class JobSubmitter {
	...
	public static void main(String[] args) throws Exception {
		...
		System.setProperty("HADOOP_USER_NAME", "hecj");
		...
		conf.set("yarn.resourcemanager.hostname", "ubuntu1");
		...
		// 1、封装参数：jar包所在的位置
		job.setJar("/Users/hecj/workspace/idea/hadoop/hadoop-demo/target/hadoop-demo-0.0.1-SNAPSHOT.jar");
