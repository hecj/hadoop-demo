package com.hadoop.mr.count.sort;
...
public static void main(String[] args) throws Exception {
	...
	Configuration conf = new Configuration();
		...
		FileInputFormat.setInputPaths(job, new Path("/hadoop/topn_out"));
		FileOutputFormat.setOutputPath(job, new Path("/hadoop/topn_out2"));
